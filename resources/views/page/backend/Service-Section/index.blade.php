                            ...
                            <div class="table-responsive scrollbar">
                                <table class="table mb-0">
                                    ...
                                    <tbody id="bulk-select-body">
                                        @forelse ($services as $items)
                                            <tr>
                                                <th class="align-middle">{{ $loop->index + 1 }}</th>
                                                <th class="align-middle">{{ $items->icone }}</th>
                                                <td class="align-middle">{{ $items->service_name }}</td>
                                            ...
                                            {{-- Intro Edit Modal --}}
                                            @include('page.backend.Service-Section.modal-include.edit')
                                            @include('page.backend.Service-Section.modal-include.delete')
                                        @empty
                                            <tr>
                                ...
                                {{-- Insert New Modal --}}
                                @include('page.backend.Service-Section.modal-include.add')

                    ...
                    <div class="card shadow-none">
                        <div class="card-body p-0 pb-3">
                            ...
                            <div class="table-responsive scrollbar">
                                <table class="table mb-0">
                                    ...
                                    <tbody id="bulk-select-body">
                                        @forelse ($Categories as $items)
                                            ...
                                            {{-- Intro Edit Modal --}}
                                            @include('page.backend.Blog-section.modal-include.Categories-modal.edit')
                                            @include('page.backend.Blog-section.modal-include.Categories-modal.delete')
                                        @empty
                                            <tr>
                                                <td class="alert-danger text-center" colspan="3">No Data in this Table</td>
                                            </tr>
                                        @endforelse
                                ...
                                {{-- Insert New Modal --}}
                                @include('page.backend.Blog-section.modal-include.Categories-modal.add')
                            </div>
                            {{ $Categories->links() }}
                        </div>
                    </div>
